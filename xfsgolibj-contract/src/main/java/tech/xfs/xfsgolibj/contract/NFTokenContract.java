...
public class NFTokenContract extends Contract<NFTokenContract.Caller, NFTokenContract.Sender> {
    ...
    public static final class Caller extends Contract.Caller {
        ...
        public String TokenUri(CallOpts opts, BigInteger tokenId) throws Exception {
            Object result = call(opts, "TokenUri", tokenId);
            return (String) result;
        }
    ...
    public static final class Sender extends Contract.Sender {
        ...
        public Hash Mint(TransactionOpts opts, Address address, String tokenUri) throws Exception {
            return send(opts, "Mint", address, tokenUri);
        }

...
public class StdTokenExample {
    ...
    private static void usage() {
        System.out.println("Usage: [command] [options] \n" +
                ...
                "transferFrom <from> <to> <n>        使用 from 地址向 to 地址转移 n 个代币（需要授权）\n" +
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger.info("正在部署合约，创建者地址: {}", creator.getAddress());
        // 部署代币合约，要带入部署参数
        ...
        logger.info("合约 {} 部署消息已发送，等待上链打包以及交易 {} 确认, 当前确认次数: {}",
        ...
        eventLogObserver.setEventObserverListener((event, data) -> {
            ...
            logger.info("接受转移事件，发送地址：{}，目标地址：{}, 转移数量：{}", fromAddress, toAddress, value);
            ...
            try {
                ...
                switch (command) {
                    ...
                    case "mint":
                        ...
                        mintOpts.setFrom(contractAddress);
